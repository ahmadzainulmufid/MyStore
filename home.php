                ...
                <div class="user-actions">
                    <div class="menu">
                        <ul>
                            ...
                            <li><a href="#" style="color: #fff; text-decoration: none;">List Pembelian</a></li>
                        </ul>
                    </div>
                    <div class="user-auth">
                        <a href="login.php" class="btn-login"
                            style="background-color: #fff; color: #007bff; text-decoration: none;">Login</a>
                        <a href="register.php" class="btn-register"
                            style="background-color: #fff; color: #007bff; text-decoration: none;">Register</a>
                    </div>
                </div>
            </div>
        </div>
